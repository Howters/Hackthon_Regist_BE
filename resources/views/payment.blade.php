                ...
                <div id="earlybird">
                    ...
                    <div class="panel">
                        <div id="time" style="display: flex; justify-content: center; gap: 15px;">
                            <img src="login page/assets/time.png" alt="" style="width: 40px; height: 40px; margin-top: 4.5rem;">
                            <p style="margin-top: 20px; font-size: 15px; font-family: 'Poppins', sans-serif;">29 - 31 Januari 2023</p>
                        </div>
                        <div id="price" style="display: flex; justify-content: left; gap: 15px; margin: 5px 1.5rem;">
                            <img src="login page/assets/pricetag.png" alt="" style="width: 40px; height: 40px; margin-top: 0.5rem;">
                            <p style="position: relative; top: -2.8rem; font-size: 15px; font-family: 'Poppins', sans-serif;">Rp. 150.000,00 </p>
                        </div>
                    </div>
                </div>
                <div id="general">
                    ...
                    <div class="panel1">
                        <div id="time" style="display: flex; justify-content: center; gap: 15px;">
                            <img src="login page/assets/time.png" alt="" style="width: 40px; height: 40px; margin-top: 4.5rem;">
                            <p style="margin-top: 20px; font-size: 15px; font-family: 'Poppins', sans-serif;">10-25 Februari 2023</p>
                        </div>
                        <div id="price"; justify-content: left; gap: 15px; margin: 5px 1.5rem;>
                            <img src="login page/assets/pricetag.png" alt="" style="width: 40px; height: 40px; position: relative; left: -15px; top: -40px;">
                            <img src="login page/assets/harga.png" style="width: 130px;
                            height: 125px; margin-top: 0.5rem;" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="pembayaran">
        <div class="container">
            ...
            <div class="dropdown">
                <div class="toggle">
                    <button">
                        <p>Pembayaran Biaya Pendaftaran<i class="fa fa-caret-down"   aria-hidden="true" style="font-size: 20px;"></i></p>
            ...
            <div class="dropdown">
                <div class="toggle">
                    <button">
                        <p>Upload Bukti Pembayaran<i class="fa fa-caret-down"   aria-hidden="true" style="font-size: 20px; padding-left: 915px;"></i></p>
                ...
                <div class="dropdown">
                    <div class="toggle">
                        <button">
                            <p>Verifikasi Pembayaran<i class="fa fa-caret-down"   aria-hidden="true" style="font-size: 20px; padding-left: 945px;"></i></p>
                    ...
                    <div class="parag2">
                        ...
                        <div class="verif-status" style="display: flex; gap: 1.5rem; justify-content: space-around;">
                            ...
                            <p style="background: linear-gradient(180deg, #FFB26C 0%, rgba(238, 199, 198, 0) 100%);
                            border: 0.869369px solid #2B2229;">Sudah Terverifikasi</p>
                            <p>Gagal Terverifikasi</p>
                        </div>

                        <p id="desc1">Untuk memastikan kelancaran acara Hackthon, sangat disarankan untuk memastikan status
